...
$env.POSH_THEME = (echo "C:\\Users\\chr_58\\Downloads\\zash.omp.json")
$env.PROMPT_INDICATOR = ""
$env.POSH_SESSION_ID = "f3d08fbe-cda9-4214-b1ac-de0b2efcb16a"
$env.POSH_SHELL = "nu"
...
let _omp_executable: string = (echo "C:/Program Files (x86)/oh-my-posh/bin/oh-my-posh.exe")
